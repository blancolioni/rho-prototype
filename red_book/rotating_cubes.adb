...
package body Rotating_Cubes is
   ...
   procedure Create_Window is
      ...
      Left_Node   : constant Rho.Node.Rho_Node :=
                      Top_Node.Create_Child ("left");
      Right_Node  : constant Rho.Node.Rho_Node :=
                      Top_Node.Create_Child ("right");
   ...
   begin
      ...
      Left_Node.Set_Entity (Rho.Shapes.Cube);
      Left_Node.Set_Position (-1.5, 0.0, 0.0);

      Right_Node.Set_Entity (Rho.Shapes.Cube);
      Right_Node.Set_Position (1.5, 0.0, 0.0);
   ...
   begin
      ...
      declare
         use Rho.Matrices;
         Cube_Rotation : constant Matrix_3 :=
                           Rotation_Matrix
                             (Listener.Cube_Degrees, (0.0, 1.0, 0.0));
         Bar_Rotation  : constant Matrix_3 :=
                           Rotation_Matrix
                             (Listener.Bar_Degrees, (0.0, 1.0, 0.0));
      begin
         Listener.Left_Cube.Set_Orientation (Cube_Rotation);
         Listener.Right_Cube.Set_Orientation (Cube_Rotation);
